        ...
        switch (packet.getAction()) {
            case ADD: {
                for (org.cloudburstmc.protocol.bedrock.packet.PlayerListPacket.Entry entry : packet.getEntries()) {
                    ...
                    String name = TextFormat.colorizeToCc(String.valueOf(entry.getName()), Utils.containsExt(ProxyServer.getInstance().getExtDatapacks().get(17), player.getExtensionsClassic()));
